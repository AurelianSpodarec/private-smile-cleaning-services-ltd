...
export default function Footer2() {
    return (
        <>
            {/* <!-- FOOTER START --> */}
            <div className="footer-area padding-remove footertext-hover">
                <div className="container">
                    <div className="row">
                        <div className="col-xl-2 col-lg-2 col-md-4">
                            <div className="footer_logo wow  fadeInUp" data-wow-duration="2s" data-wow-delay=".2s">
                            ...
                            <div className="footer_widget_design wow  fadeInUp" data-wow-duration="2s" data-wow-delay=".2s">
                                ...
                                <div className="links">
                                    <ul>
                                        ...
                                        <li><Link href="/about"><a>About</a></Link></li>
                                        <li><Link href="/about"><a>Help</a></Link></li>
                        ...
                        <div className="row align-items-center">
                            <div className="col-xl-6 col-lg-6 col-md-6">
                                <div className="copyright_text pt-20">
                                    <p>@ 2021 All Copyright Reserved. Design by <span className="colorlightblue">Theme_Pure</span></p>
                                </div>
                            </div>
                            <div className="col-xl-6 col-lg-6 col-md-6">
