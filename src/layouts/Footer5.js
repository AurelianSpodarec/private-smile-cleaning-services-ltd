...
export default function Footer5(className) {
    return (
        <>
            {/* <!-- FOOTER START --> */}
            <div className="footer-area padding-remove">
                    ...
                    <div className="row">
                        ...
                        <div className="col-xl-2 col-lg-2 col-md-4">
                            <div className="footer_widget_design wow  fadeInUp" data-wow-duration="2s" data-wow-delay=".2s">
                                ...
                                <div className="links">
                                    <ul>
                                        <li><Link href="/about"><a>Project</a></Link></li>
                                        <li><Link href="/about"><a>About</a></Link></li>
                                ...
                                <div className="links special_widget_tp">
                                    <ul>
                                        <li><Link href="/contact"><a><i className="far fa-map-marker-alt"></i><span
                                            className="tp-spaceing">99, Kazi Nazrul Islam Avenue (Dhaka Trade Centre - 5th
                                            Floor) Kawran Bazar, Dhaka-1215.</span></a></Link></li>
                                        <li><Link href="tel:+8801821243622"><a><i className="fad fa-phone-alt"></i>+880 1821 243 622</a></Link>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div className="row align-items-center">
                            <div className="col-xl-6 col-lg-6 col-md-6">
                                <div className="copyright_text pt-20">
                                    <p>@ 2021 All Copyright Reserved. Design by <span>Theme_Pure</span></p>
                                </div>
                            </div>
                            <div className="col-xl-6 col-lg-6 col-md-6">
