...
export default function TestimonialOne() {
    ...
    return (
        <>
            {/* <!-- TESTIMONIAL START  --> */}
            <div className="testimonial-area  bg1 pt-110 mb-50">
                ...
                <div className="container">
                    <div className="row">
                     ...
                     <Swiper
                        ...
                        <div className="testimonial-item pt-55">
                            <div className="item">
                                <p>Matie boy it&#39;s your round amongst bodge vagabond absolutely bladdered crikey well off
                                    his nut have it, goal you mug loo don&#39;t super.</p>
                                <div className="clients_meta">
                                    <div className="clients_image">
                                        <img src="/img/testimonial/test3.jpg" alt="clients_image" />
                                    </div>
                                    <div className="clients_info">
                                        <h4>Brian Cumin</h4>
                    ...
                    <div className="col-xl-4 col-lg-4">
                        <div className="testimonial-item pt-55">
                            <div className="item">
                                ...
                                <div className="clients_meta">
                                    <div className="clients_image">
                                        <img src="/img/testimonial/test2.jpg" alt="clients_image" />
                                    </div>
                                    <div className="clients_info">
                                        <h4>Indigo Violet</h4>
                                        <span>Ui/Ux Designer</span>
