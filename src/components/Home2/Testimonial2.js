                ...
                <div className="container">
                    <div className="row justify-content-center">
                        <div className="col-xl-8 col-lg-10">
                            <div className="testimonial-active2 tp-dot-style position-relative">
                                ...
                                <button type="button" className="testimonial_prev slick-prev slick-arrow" style={{ "display": "block;" }}><i className="fal fa-long-arrow-left"></i></button>
                                <button type="button" className="testimonial_next slick-next slick-arrow" style={{ "display": "block;" }}><i className="fal fa-long-arrow-right"></i></button>
