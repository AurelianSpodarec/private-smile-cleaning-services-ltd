...
export default function BlogClassicPageTitle() {
    return (
        <>
            {/* <!-- page title start  --> */}
            <section className="page__title  fix text-center">
                    ...
                    <div className="row">
                        <div className="col-xl-12">
                            <div className="page__title-content pt-235">
                                <h2 className="page_title">Our Blog . Classic</h2>
                                <nav aria-label="breadcrumb">
                                    <ol className="breadcrumb">
                                        <li className="breadcrumb-item"><Link href="/"><a>Home - Gird with Sidebar</a></Link></li>
                                    </ol>
                                </nav>
                            </div>
                        </div>
